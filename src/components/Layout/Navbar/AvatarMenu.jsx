...
import { Brightness4, Brightness5, Check, Logout, PersonAdd, Settings, SettingsBrightness } from '@mui/icons-material';
...
function AvatarMenu() {
    ...
    const renderColorModeOptions = () => {
        return colorModes.map((mode) => {
            return (
            <MenuItem selected={themeState === mode.value} onClick={() => setThemeState(mode.value)}>
                <ListItemIcon>
                    {mode.icon}
                </ListItemIcon>
                <ListItemText>
